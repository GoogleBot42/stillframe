...
EL133UF1 = el133uf1_ns.class_(
    "EL133UF1", cg.Component, spi.SPIDevice, eink_frame.EinkFrameDisplay
)
...
CONFIG_SCHEMA = (
    ...
    # The panel resolution is fixed, so no width/height keys — the rotation
    # decides what the driver asks the server for.
    .extend(eink_frame.EINK_FRAME_SCHEMA)
